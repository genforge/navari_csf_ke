            ...
            if tax_amount:
                ...
                row = {
                    "pan" if frappe.db.has_column(filters.party_type, "pan") else "tax_id": party_map.get(
                        party, {}
                    ).get("pan") or party_map.get(party, {}).get("tax_id"),
...
def get_journal_entry_party_map(journal_entries):
    ...
    for d in frappe.db.get_all(
        ...
        ["parent", "party", "reference_type", "reference_name", "reference_due_date", "debit", "credit"],
    ):
        ...
        journal_entry_party_map[d.parent].append(d.reference_type)
        journal_entry_party_map[d.parent].append(d.reference_name)
        journal_entry_party_map[d.parent].append(d.reference_due_date)
        journal_entry_party_map[d.parent].append(d.debit)
        journal_entry_party_map[d.parent].append(d.credit)
